...
static const char *fonts[]          = { "Inter:size=10:size=10:antialias=true:autohint=true", "Apple Color Emoji:size=12:antialias=true:autohint=true", "Symbols Nerd Font:size=12:antialias=true:autohint=true" };
