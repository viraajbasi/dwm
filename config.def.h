...
static const char *fonts[]          = { "Caskaydia Cove Nerd Font:size=16", "JoyPixels:pixelsize=16:antialias=true:autohint=true" };
static const char dmenufont[]       = "Caskaydia Cove Nerd Font:size=16";
